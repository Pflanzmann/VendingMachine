...
class VendingMachineBasicsTest {
    ...
    @Test
    void swapSlot_NoThrow_Success() {
        Assertions.assertDoesNotThrow(() -> vendingMachine.swapSlots(0, 1));
        Assertions.assertDoesNotThrow(() -> vendingMachine.swapSlots(1, 0));
        Assertions.assertDoesNotThrow(() -> vendingMachine.swapSlots(0, 0));
        Assertions.assertDoesNotThrow(() -> vendingMachine.swapSlots(TEST_SLOTS - 1, TEST_SLOTS - 1));
    }

    @Test
    void swapSlot_OutOfBounds_SwapNotPossibleException() {
        Assertions.assertThrows(SwapNotPossibleException.class, () -> vendingMachine.swapSlots(-1, 1));
        Assertions.assertThrows(SwapNotPossibleException.class, () -> vendingMachine.swapSlots(1, -1));
        Assertions.assertThrows(SwapNotPossibleException.class, () -> vendingMachine.swapSlots(1, -1));
        Assertions.assertThrows(SwapNotPossibleException.class, () -> vendingMachine.swapSlots(1563135, 1));
        Assertions.assertThrows(SwapNotPossibleException.class, () -> vendingMachine.swapSlots(1, 1563135));
        Assertions.assertThrows(SwapNotPossibleException.class, () -> vendingMachine.swapSlots(0, TEST_SLOTS));
        Assertions.assertThrows(SwapNotPossibleException.class, () -> vendingMachine.swapSlots(TEST_SLOTS, 0));
    }

    @Test
    void swapSlot_Success() {
        Manufacturer Manufacturer = new Manufacturer(TEST_FACTORY_NAME1);
        ...
        Assertions.assertEquals(cake1, vendingMachine.getCakeFromSlot(0));
        Assertions.assertNull(vendingMachine.getCakeFromSlot(2));
        Assertions.assertDoesNotThrow(() -> vendingMachine.swapSlots(0, 2));
        Assertions.assertNull(vendingMachine.getCakeFromSlot(0));
        Assertions.assertEquals(cake1, vendingMachine.getCakeFromSlot(2));
    }

    @Test
    void swapSlot_Failed() {
        Manufacturer Manufacturer = new Manufacturer(TEST_FACTORY_NAME1);
        ...
        Assertions.assertEquals(cake1, vendingMachine.getCakeFromSlot(0));
        Assertions.assertThrows(SwapNotPossibleException.class, () -> vendingMachine.swapSlots(0, 50));
        Assertions.assertEquals(cake1, vendingMachine.getCakeFromSlot(0));
        Assertions.assertNull(vendingMachine.getCakeFromSlot(50));
    }
}