    ...
    public void startCli() {
        new Thread() {
            ...
            public void run() {
                ...
                showAllCakesEventHandler.addListener(new ShowAllCakesStreamListener(objectOutputStreamCakeListener));
                showManufacturerEventHandler.addListener(new ShowAllManufacturersStreamListener(objectOutputStreamManufacturerListener));
