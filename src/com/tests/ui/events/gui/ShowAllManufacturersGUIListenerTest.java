...
class ShowAllManufacturersGUIListenerTest {
    ...
    void handle() throws IOException, ClassNotFoundException {
        ...
        ShowAllManufacturersGUIListener showAllManufacturersGUIListener = new ShowAllManufacturersGUIListener(oos);
        ...
        showAllManufacturersGUIListener.handle(testManufacturerList);
