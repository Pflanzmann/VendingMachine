...
import com.simulation.runnables.OutsourceThread;
import com.simulation.runnables.StoreThread;
...
public class Main_Simulation {
    public static void main(String[] args) {
        while (true) {
            ...
            Thread threadStore1 = new Thread(new StoreThread("StoreThread0", System.out, vendingMachines, manufacturerName, storeLock1));
            Thread threadStore2 = new Thread(new StoreThread("StoreThread1", System.out, vendingMachines, manufacturerName, storeLock1));
